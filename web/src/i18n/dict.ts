...
export const zh: Dict = {
  ...
  'pick.ownGoal': '对手乌龙',
  'pick.ownGoalPickScorer': '选择送给 {side} 的乌龙球员',
  'pick.ownGoalNoScorer': '记录乌龙（不指定球员）',

  // ── shootout ─────────────────────────────────────────────────────────
  'shootout.title': '点球大战',
  'shootout.tiedHint': '常规时间战平，可进入点球大战决出胜者。',
  'shootout.enter': '进入点球大战',
  'shootout.firstKicker': '选择首罚球队',
  'shootout.nextKick': '轮到 {team} 罚点球',
  'shootout.awaitingResume': '等待下一轮',
  'shootout.decided': '{team} 领先（点球 {madeA}:{madeB}），可点击"结束点球大战"确认结果',
  'shootout.ended': '{team} 通过点球大战胜出（{madeA}:{madeB}）',
  'shootout.attempts': '{count} 罚',
  'shootout.emptyMarkers': '尚未开始',
  'shootout.unknownKicker': '未指定',
  'shootout.pickKicker': '选择 {team} 主罚球员',
  'shootout.result': '{name} 的这一脚',
  'shootout.made': '罚进 ✓',
  'shootout.missed': '未进 ✕',
  'shootout.backToKicker': '返回改球员',
  'shootout.undoLast': '撤销最近一次点球',
  'shootout.end': '结束点球大战',
  'shootout.endDisabledHint': '需两队轮数相同且已分出胜负',
  'shootout.reopen': '重新打开点球大战',
  ...
  'feed.ownGoal': '{side} 乌龙送分',
  'feed.ownGoalNoSide': '乌龙球',
  'feed.ownGoalScorer': '{scorer} 乌龙',
  'feed.penaltyMade': '{side} 点球 · {scorer} 罚进',
  'feed.penaltyMadeAnon': '{side} 点球罚进',
  'feed.penaltyMadeAnonNoSide': '点球罚进',
  'feed.penaltyMissed': '{side} 点球 · {scorer} 未进',
  'feed.penaltyMissedAnon': '{side} 点球未进',
  'feed.penaltyMissedAnonNoSide': '点球未进',
  'feed.undo': '撤销',
  ...
  'reports.fixtures.winnerPk': '{team} 点球胜',
  'score.shootoutBadge': '点球 {a} - {b}',
  ...
  'reports.verdictWinsOnPenalties': '点球胜出',
  'reports.shootout': '点球大战',
  'reports.shootout.winner': '{team} 以 {madeA}-{madeB} 赢得点球大战',
  'reports.shootout.pending': '点球大战进行中',
...
export const en: Dict = {
  ...
  'pick.scorerSide': 'Pick scorer for {side}',
  ...
  'pick.ownGoal': 'Own goal by opponent',
  'pick.ownGoalPickScorer': 'Pick the opposing player who scored the OG (credited to {side})',
  'pick.ownGoalNoScorer': 'Record OG without a specific player',

  // ── shootout ─────────────────────────────────────────────────────────
  'shootout.title': 'Penalty shootout',
  'shootout.tiedHint': 'Regulation ended level. Decide the winner with penalty kicks.',
  'shootout.enter': 'Start shootout',
  'shootout.firstKicker': 'Pick which team kicks first',
  'shootout.nextKick': '{team} to kick next',
  'shootout.awaitingResume': 'Awaiting next kick',
  'shootout.decided':
    '{team} leads ({madeA}-{madeB}). Tap "End shootout" to lock in the result.',
  'shootout.ended': '{team} won the shootout ({madeA}-{madeB})',
  'shootout.attempts': '{count} taken',
  'shootout.emptyMarkers': 'No kicks yet',
  'shootout.unknownKicker': 'Unknown',
  'shootout.pickKicker': 'Pick the kicker for {team}',
  'shootout.result': '{name}\u2019s kick',
  'shootout.made': 'Scored ✓',
  'shootout.missed': 'Missed ✕',
  'shootout.backToKicker': 'Back to picker',
  'shootout.undoLast': 'Undo last kick',
  'shootout.end': 'End shootout',
  'shootout.endDisabledHint': 'Rounds must match and a winner must have emerged',
  'shootout.reopen': 'Reopen shootout',
  ...
  'feed.ownGoalScorer': '{scorer} · own goal',
  'feed.penaltyMade': '{side} penalty · {scorer} scored',
  'feed.penaltyMadeAnon': '{side} penalty scored',
  'feed.penaltyMadeAnonNoSide': 'Penalty scored',
  'feed.penaltyMissed': '{side} penalty · {scorer} missed',
  'feed.penaltyMissedAnon': '{side} penalty missed',
  'feed.penaltyMissedAnonNoSide': 'Penalty missed',
  'feed.undo': 'Undo',
  ...
  'reports.fixtures.winnerPk': '{team} wins on PK',
  'score.shootoutBadge': 'Pens {a} - {b}',
  ...
  'reports.verdictWins': 'wins',
  'reports.verdictDraw': 'Draw',
  'reports.verdictWinsOnPenalties': 'wins on penalties',
  'reports.shootout': 'Penalty shootout',
  'reports.shootout.winner': '{team} wins the shootout ({madeA}-{madeB})',
  'reports.shootout.pending': 'Shootout in progress',
