      ...
      <div className="relative mx-auto max-w-3xl px-6 py-8 sm:px-8 lg:px-10 lg:py-12">
          ...
          <form onSubmit={onFinish} className="space-y-10">
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-3">
                <label className="inline-block ml-1 text-[11px] font-black tracking-[0.2em] text-neutral-500">登录账号</label>
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-3">
                <label className="inline-block ml-1 text-[11px] font-black tracking-[0.2em] text-neutral-500">球场昵称</label>
                <div className="group flex h-14 items-center rounded-2xl border border-neutral-800 bg-black/40 px-5 transition-all duration-300 focus-within:border-primary/40 focus-within:bg-neutral-950">
                  <input
              ...
              <div className="space-y-3">
                <label className="inline-block ml-1 text-[11px] font-black tracking-[0.2em] text-neutral-500">真实姓名</label>
                <div className="group flex h-14 items-center rounded-2xl border border-neutral-800 bg-black/40 px-5 transition-all duration-300 focus-within:border-primary/40 focus-within:bg-neutral-950">
                  <input
        ...
        <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
          <div className="rounded-[1.5rem] border border-neutral-900 bg-neutral-950/70 px-4 py-4 text-center">
            ...
            <div className="text-xs font-bold text-neutral-400">身份资料更完整</div>
          </div>
          <div className="rounded-[1.5rem] border border-neutral-900 bg-neutral-950/70 px-4 py-4 text-center">
            <div className="text-[10px] font-black uppercase tracking-[0.2em] text-primary mb-2">Position</div>
            <div className="text-xs font-bold text-neutral-400">位置偏好更清晰</div>
          </div>
          <div className="rounded-[1.5rem] border border-neutral-900 bg-neutral-950/70 px-4 py-4 text-center">
            <div className="text-[10px] font-black uppercase tracking-[0.2em] text-primary mb-2">Ready</div>
            <div className="text-xs font-bold text-neutral-400">注册完成即可开赛</div>
          </div>
        </div>
      </div>
    </div>
