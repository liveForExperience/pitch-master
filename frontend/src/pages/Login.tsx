...
import { ArrowRight, User as UserIcon, Lock, ShieldCheck } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 relative items-stretch p-8 xl:p-10">
        ...
        {/* 动态背景光效 */}
          ...
          <div className="relative z-10 max-w-2xl">
            ...
            <h1 className="text-6xl xl:text-7xl font-black text-white leading-[0.95] tracking-tighter mb-8">
              回到赛场
              <br />
              从这里开始
            </h1>
            <p className="max-w-lg text-lg xl:text-xl leading-relaxed text-neutral-500 font-medium">
          ...
          <div className="relative z-10 grid grid-cols-3 gap-4">
            <div className="rounded-[1.75rem] border border-white/10 bg-white/5 p-5">
              ...
              <div className="text-sm font-bold text-white leading-6">赛事组织与报名流程更清晰</div>
            </div>
            <div className="rounded-[1.75rem] border border-white/10 bg-white/5 p-5">
              <div className="text-[10px] font-black uppercase tracking-[0.25em] text-primary mb-3">Group</div>
              <div className="text-sm font-bold text-white leading-6">智能分组逻辑保持统一体验</div>
            </div>
            <div className="rounded-[1.75rem] border border-white/10 bg-white/5 p-5">
              <div className="text-[10px] font-black uppercase tracking-[0.25em] text-primary mb-3">Live</div>
              <div className="text-sm font-bold text-white leading-6">实时比分与状态反馈更直接</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center px-6 py-8 sm:px-8 lg:px-10 bg-black relative">
        ...
        <div className="w-full max-w-md relative z-10">
          <div className="mb-10 text-left">
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-white mb-4 tracking-tighter">登入竞技场</h2>
            <p className="text-neutral-500 font-medium text-base sm:text-lg">准备好回到你的比赛日节奏了吗？</p>
          </div>

          <div className="rounded-[2.5rem] border border-neutral-900 bg-neutral-950/90 p-6 sm:p-8 shadow-[0_24px_80px_rgba(0,0,0,0.45)]">
            <div className="flex items-center space-x-2 text-neutral-400 font-black text-[10px] uppercase tracking-widest border-b border-neutral-900 pb-4 mb-8">
            ...
            <form onSubmit={onFinish} className="space-y-8">
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <label className="inline-block ml-1 text-[11px] font-black tracking-[0.2em] text-neutral-500">球员账号</label>
                  <div className="group flex h-16 items-center rounded-2xl border border-neutral-800 bg-black/40 px-5 transition-all duration-300 focus-within:border-primary/40 focus-within:bg-neutral-950">
                    <UserIcon size={18} className="mr-4 text-neutral-600 transition-colors duration-300 group-focus-within:text-primary" />
                    <input
                      ...
                      className="auth-input h-full w-full bg-transparent text-base font-bold text-white placeholder:text-neutral-600 outline-none"
                    />
                  </div>
                </div>
                ...
                {/* 密码输入区 */}
                <div className="space-y-3">
                  <label className="inline-block ml-1 text-[11px] font-black tracking-[0.2em] text-neutral-500">安全密码</label>
                  <div className="group flex h-16 items-center rounded-2xl border border-neutral-800 bg-black/40 px-5 transition-all duration-300 focus-within:border-primary/40 focus-within:bg-neutral-950">
                    <Lock size={18} className="mr-4 text-neutral-600 transition-colors duration-300 group-focus-within:text-primary" />
                    <input
